...
const adminScreenshots = [
  ...
  {
    src: '/assets/article_view_unassign.jpeg',
    caption: 'Article View Unassign',
  },
  {
    src: '/assets/article_view_unassign1.jpeg',
    caption: 'Article View Unassign',
  },
...
const subscribeToCursorGlow = (callback: () => void) => {
  ...
  const onStorage = (event: StorageEvent) => {
    if (
      ...
      event.key === CURSOR_GLOW_STORAGE_KEY
    ) {
      callback()
    }
  }
...
export default function Home() {
  ...
  const handleScreenshotCardKeyDown = (
  ...
  const sendTesterEmail = async () => {
    ...
    try {
      const response = await fetch(
        `${API_BASE_URL}/api/publishing-related/invite-testflight`,
        {
          method: 'POST',
 ...
 {/* fix-unreachable-launching-soon-modal */}
      ...
      <Section id="screenshots" className="bg-[#F7FAFC] dark:!bg-slate-800">
        <PageWrapper>
          ...
          <div className="screenshot-details bg-white dark:bg-gray-800 border border-white dark:border-gray-600 shadow-md dark:shadow-black/40 transition-all duration-300 hover:-translate-y-1">
            <div
              className="screenshot-summary text-black dark:text-white"
      ...
      <Section id="features" className="scroll-reveal dark:!bg-slate-900">
        <PageWrapper>
          ...
          <p className="center">
            UltimateHealth is an open-source health platform that provides
            trusted articles, AI-powered assistance, podcasts, multilingual
            content, community contributions, and a centralized wellness
              ...
              [
                {
                  ...
                  desc: 'Get instant, AI-powered health guidance and support.',
                  span: 'md:col-span-2 lg:col-span-2',
                },
                {
                  icon: 'fa-book-medical',
                  title: 'Centralized Library',
                  desc: 'Access a vast repository of trusted health articles.',
                  span: 'col-span-1',
                },

                {
                  icon: 'fa-edit',
                  title: 'CRUD Articles',
                  desc: 'Create, read, update, and delete your health content seamlessly.',
                  span: 'col-span-1',
                },
                {
                  icon: 'fa-podcast',
                  title: 'Health Podcasts',
                  desc: 'Stream and share verified health audio content worldwide.',
                  span: 'md:col-span-2 lg:col-span-2',
                },

                {
                  ...
                  desc: 'Organize articles with intuitive categorization and tagging.',
                  span: 'col-span-1',
                },
                {
                  icon: 'fa-search',
                  title: 'Advanced Search',
                  desc: 'Quickly find the specific health information you need.',
                  span: 'col-span-1',
                },
                {
                  icon: 'fa-users',
                  title: 'Community Contributions',
                  desc: 'Collaborate and drive open-source content creation.',
                  span: 'col-span-1',
                },

                {
                  ...
                  desc: 'Propose and review changes to maintain content quality.',
                  span: 'col-span-1',
                },
                {
                  icon: 'fa-language',
                  title: 'Multilingual Resources',
                  desc: 'Read and write content in multiple languages globally.',
                  span: 'col-span-1',
                },
                {
                  icon: 'fa-mobile-alt',
                  title: 'Cross-Platform Support',
                  desc: 'Available on both Android mobile and Web platforms.',
                  span: 'col-span-1',
                },

                {
                  ...
                  desc: 'Secure role-based access and robust user management.',
                  span: 'col-span-1',
                },
                {
                  icon: 'fa-cloud',
                  title: 'Cloud Content Management',
                  desc: 'Reliable cloud infrastructure for all your health data.',
                  span: 'col-span-1',
                },
                {
                  icon: 'fa-graduation-cap',
                  title: 'Educational Content',
                  desc: 'Spread health awareness through verified information.',
                  span: 'col-span-1',
                },

                {
                  icon: 'fa-shield-alt',
                  title: 'Trusted Wellness Repository',
                  desc: 'A heavily moderated, safe, and accurate knowledge base.',
                  span: 'md:col-span-2 lg:col-span-2',
                },
                {
                  icon: 'fa-globe',
                  title: 'Open-Source Platform',
                  desc: 'Join our global initiative for a healthier community.',
                  span: 'col-span-1',
                },
              ].map((f, i) => (
                <div
                ...
                >
                  <h3 className="text-black dark:!text-white">
                    {' '}
                    <i className={`fas ${f.icon}`}></i> {f.title}
                  </h3>
                  <p>{f.desc}</p>
                </div>
              ))
      ...
      <Section className="member-section scroll-reveal bg-[#F7FAFC] dark:!bg-gray-600">
        <PageWrapper>
          <h2 className="dark:!text-red-500">
            Be a Member: Guardian of Content Integrity
          </h2>
          <p className="center">
            Help maintain quality and safety across the platform
          </p>
            ...
            {[
              {
                ...
                desc: 'Manage the full lifecycle of content with a streamlined approval, rejection, and feedback loop for contributors.',
              },
              {
                icon: 'fa-microchip',
                title: 'Content Integrity',
                desc: 'Leverage automated plagiarism and grammar engines to maintain professional clarity and originality scores.',
              },
              {
                icon: 'fa-shield-alt',
                title: 'Visual Asset Audit',
                desc: 'Validation for image quality and automated compliance checks for brand logos and visual safety. (Coming Soon)',
              },
              {
                icon: 'fa-gavel',
                title: 'Community Safety',
                desc: 'Investigate flagged content and manage user reports through a robust system designed to keep the platform safe.',
              },
              {
                icon: 'fa-fingerprint',
                title: 'Advanced Security',
                desc: 'Role-based access control (RBAC) ensuring only verified Reviewers and Admins can access protected operations.',
              },
            ].map((f) => (
              <div className="feature-card mod-card w-full fade-in bg-white dark:bg-slate-800 ">
      ...
      <Section id="programs" className="scroll-reveal dark:bg-slate-900">
        <PageWrapper>
          ...
          <p className="center">
            We are proud to have collaborated with and contributed to these
            prestigious tech and open-source initiatives
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 mt-16 w-full">
            {[
              {
              ...
              >
                ...
                <span className="program-badge bg-[#1e2736] dark:text-white">
                  {p.badge}
                </span>
      ...
      {/* ── Contact ── */}
      <Section
        className="contact-section scroll-reveal bg-white dark:!bg-gray-900"
        id="contact"
      >
        <PageWrapper>
          ...
          <div className="contact-dark-card">
            ...
            <div className="contact-dark-left">
              ...
              <h3 className="contact-dark-title">
                Let&apos;s Talk
                <br />
                Health Together
              </h3>
              <p className="contact-dark-subtitle">
                Questions about our platform? We&apos;re here to help. Reach out
            ...
            <div className="bg-white dark:bg-gray-800 contact-dark-right">
              <h3 className="contact-form-title text-[#1a202c] dark:!text-white">
                Send us a Message
              </h3>
              <p className="contact-form-subtitle text-gray-400 dark:text-gray-400">
              ...
              {contactStatus === 'success' ? (
                ...
                >
                  ...
                  <div className="dark-field-group group dark-field-textarea">
                    <span className="dark-field-icon dark-field-icon-top mt-3 dark:text-gray-400 group-focus-within:text-purple-500 transition-colors duration-300">
                  ...
                  {contactStatus === 'error' && (
                    <p className="contact-error-msg">
                      <i className="fas fa-exclamation-circle"></i> Something
                      went wrong. Opening your email client as fallback.
                    </p>
                  )}
                  ...
                  <div className="contact-trust">
                    ...
                    <span className="contact-trust-text">
      ...
      <footer>
        ...
        <div className="footer-bottom">
          <div className="footer-bottom-inner">
            <p>
              © 2026 UltimateHealth. Built with passion for a healthier
              community.
            </p>
      ...
      {comingSoonModal && (
        ...
        >
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            >
              We&apos;re currently in final testing. We&apos;re{' '}
              <strong>85%</strong> of the way there!
            </p>
      ...
      >
        ...
        >
          ...
          <p style={{ color: 'var(--text-muted)', marginBottom: 24 }}>
            Help us build the ultimate experience
          </p>
          <div
            style={{
              textAlign: 'left',
            ...
            className="bg-[#f8fafc] dark:bg-slate-700 text-black dark:text-white"
          >
            <p style={{ marginBottom: 12 }}>
              We have decided to release via <strong>TestFlight</strong> first
              before moving to a full App Store launch.
            </p>
            <p style={{ marginBottom: 12 }}>
              <strong>🔹 Why TestFlight?</strong> Early feedback, real-world
              testing, and faster iteration.
            </p>
            <p style={{ marginBottom: 12 }}>
              <strong>🔹 What this means:</strong> The app will be available to
              invited testers only via TestFlight.
            </p>
            <p>
              <strong>Are you ready to test?</strong> Enter your email below to
      ...
      {screenshotModal && (
        <div className="screenshot-modal active" onClick={closeScreenshotModal}>
          ...
          >
            ...
            <button
              className="screenshot-modal-nav screenshot-modal-prev"
              type="button"
            ...
            />
            <button
              className="screenshot-modal-nav screenshot-modal-next"
              type="button"
