...
export default function Home() {
  ...
  return (
    <>
      ...
      <section id="screenshots">
        <div className="container">
          ...
          <div className="screenshot-details">
            ...
            >
              <span style={{ color: "var(--primary)" }}>{userSliderOpen ? "â–¼" : "â–¶"}</span>
              UltimateHealth App
            </div>
            {userSliderOpen && (
          ...
          <div className="screenshot-details">
            ...
            >
              <span style={{ color: "var(--primary)" }}>{adminSliderOpen ? "â–¼" : "â–¶"}</span>
              UHealth Admin App
            </div>
            {adminSliderOpen && (
              <div className="screenshot-slider-container">
      ...
      <section id="features">
        <div className="container">
          ...
          <div className="feature-grid">
            {[
              { icon: "ðŸ—£ï¸", title: "Multilingual Article Publishing", desc: "Publish health articles in your own language and reach a global audience." },
              { icon: "âœï¸", title: "Collaborative Article Improvement", desc: "Review and improve community-driven health content together." },
              { icon: "ðŸŽ§", title: "Publish Health Podcasts", desc: "Share verified health podcasts with listeners worldwide." },
              { icon: "ðŸ“Š", title: "Contribution Analytics", desc: "Track your impact across articles, edits, and podcasts." },
            ].map((f, i) => (
      ...
      <footer>
        <div className="container">
          <h2>A Heartfelt Thank You <span className="heart">â¤ï¸</span></h2>
          <p className="footer-note">
            Ultimate Health exists because of people like you. To every contributor who translated an article,
            every developer who squashed a bug, and every partner who believed in our missionâ€”thank you for helping us build
          ...
          <div className="footer-bottom">
            <p>Â© 2026 Ultimate Health. Built with passion for a healthier community.</p>
          </div>
        </div>
      </footer>
      ...
      <div className={`modal-overlay${appleModal ? " active" : ""}`} id="testflight-modal" onClick={() => { setAppleModal(false); setTesterSuccess(false); setTesterEmail(""); }}>
        <div className="modal-content" onClick={(e) => e.stopPropagation()}>
          <div style={{ fontSize: "3.5rem", marginBottom: 16 }}>âœˆï¸</div>
          ...
          <div style={{ textAlign: "left", fontSize: "0.95rem", color: "var(--text-dark)", background: "#f8fafc", padding: 24, borderRadius: 16, marginBottom: 24, borderLeft: "4px solid #007aff" }}>
            ...
            <p style={{ marginBottom: 12 }}><strong>ðŸ”¹ Why TestFlight?</strong> Early feedback, real-world testing, and faster iteration.</p>
            <p style={{ marginBottom: 12 }}><strong>ðŸ”¹ What this means:</strong> The app will be available to invited testers only via TestFlight.</p>
          ...
          {!testerSuccess ? (
            ...
            <div style={{ padding: 24, color: "#059669", background: "#d1fae5", borderRadius: 12 }}>
              <p style={{ margin: 0, fontWeight: 600 }}>âœ… <strong>Request Sent!</strong> We&apos;ll notify you as soon as the test link is ready.</p>
            </div>
          )}
      ...
      {screenshotModal && (
        <div className="screenshot-modal active" id="screenshotModal" onClick={closeScreenshotModal}>
          <div className="screenshot-modal-content" onClick={(e) => e.stopPropagation()}>
            <button className="screenshot-modal-close" id="screenshot-modal-close" onClick={closeScreenshotModal}>Ã—</button>
