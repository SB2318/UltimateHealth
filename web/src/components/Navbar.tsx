...
export default function Navbar() {
  console.log("HOME NAVBAR IS RENDERING");
    ...
    <header className={`header${scrolled ? " scrolled" : ""}`} id="header">
      <PageWrapper as="div" className="nav">
        ...
        <ul className="nav-links">
          ...
          {/* Fix: Replaced the red TEST button with the LanguageSwitcher */}
          <li className="nav-toggle-item" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <LanguageSwitcher />
          </li>
