...
export default function ArticlePageClient({
  ...
  return (
    <GlossaryProvider terms={defaultGlossaryTerms}>
      ...
      <a
        href="#article-body"
        className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-80 focus:bg-white focus:px-4 focus:py-2 focus:rounded-lg focus:shadow-lg focus:text-[#667eea] focus:font-semibold focus:border focus:border-[#667eea]/30"
      >
