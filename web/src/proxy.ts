...
export default function proxy(request: NextRequest) {
  ...
  const cspDirectives = [
    ...
    "img-src 'self' blob: data: https://raw.githubusercontent.com https://github.com https://user-images.githubusercontent.com https://avatars.githubusercontent.com https://ultimatehealth.blog https://uhsocial.in https://picsum.photos",
    "connect-src 'self' https://ultimatehealth.blog https://uhsocial.in https://api.github.com" + (isDev ? " http: ws:" : ""),
    "object-src 'none'",
    "base-uri 'self'",
