...
import {useUploadArticleToPocketbase} from './useUploadArticlePocketbase';
...
describe('useUploadArticleToPocketbase', () => {
  ...
  it('executes mutation successfully and calls API', async () => {
    ...
    const {result} = renderHook(() => useUploadArticleToPocketbase(), {
      wrapper: makeWrapper(),
    });
