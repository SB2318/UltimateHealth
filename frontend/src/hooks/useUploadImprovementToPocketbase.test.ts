...
import {useUploadImprovementToPocketbase} from './useUploadImprovementToPocketbase';
...
describe('useUploadImprovementToPocketbase', () => {
  ...
  it('executes mutation successfully and calls API', async () => {
    ...
    const {result} = renderHook(() => useUploadImprovementToPocketbase(), {
      wrapper: makeWrapper(),
    });
