...
import { useSubmitEditRequest } from '@/src/hooks/article/useSubmitEditRequestMutation';
...
describe('useSubmitEditRequest', () => {
  ...
  it('executes mutation successfully and calls API', async () => {
    ...
    const {result} = renderHook(() => useSubmitEditRequest(), {
      wrapper: makeWrapper(),
    });
