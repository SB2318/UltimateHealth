...
import { useLazyGetArticleContent } from '@/src/hooks/article/useLazyGetArticleContent';
...
describe('useLazyGetArticleContent', () => {
  ...
  it('executes mutation successfully and calls API', async () => {
    ...
    const {result} = renderHook(() => useLazyGetArticleContent(), {
      wrapper: makeWrapper(),
    });
