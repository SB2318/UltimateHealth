...
import { useUpdateUserContactDetail } from '@/src/hooks/profile/useUpdateUserContactDetail';
...
describe('useUpdateUserContactDetail', () => {
  ...
  it('executes mutation successfully and calls API', async () => {
    ...
    const {result} = renderHook(() => useUpdateUserContactDetail(), {
      wrapper: makeWrapper(),
    });
