...
import { useUpdateUserGeneralDetails } from '@/src/hooks/profile/useUpdateUserGeneralDetails';
...
describe('useUpdateUserGeneralDetails', () => {
  ...
  it('executes mutation successfully and calls API', async () => {
    ...
    const {result} = renderHook(() => useUpdateUserGeneralDetails(), {
      wrapper: makeWrapper(),
    });
