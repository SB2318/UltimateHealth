...
import { useUpdateUserProfDetails } from '@/src/hooks/profile/useUpdateUserProfDetails';
...
describe('useUpdateUserProfDetails', () => {
  ...
  it('executes mutation successfully and calls API', async () => {
    ...
    const {result} = renderHook(() => useUpdateUserProfDetails(), {
      wrapper: makeWrapper(),
    });
