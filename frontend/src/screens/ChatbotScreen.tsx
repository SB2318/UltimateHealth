...
const ChatbotScreen = ({navigation}: ChatBotScreenProps) => {
  ...
  }, [messageProcessPending, safeSetMessages, performSendMessage]);
  ...
  }, [safeSetMessages, performSendMessage]);
    ...
    <SafeAreaView style={{flex: 1, backgroundColor: 'white'}} edges={['top']}>
      <View
        ...
        <View style={{flex: 1}}>
          ...
          {(isTyping || messageProcessPending) && (
            <Text style={{fontSize: 13, color: '#3b82f6'}}>
              {messageProcessPending ? 'Generating response...' : 'typing...'}
            </Text>
          )}
        </View>
      </View>
      ...
      <KeyboardAvoidingView
        ...
        <View style={{flex: 1, backgroundColor: '#f9fafb'}}>
          <GiftedChat
            ...
            isTyping={isTyping || messageProcessPending}
            //alwaysShowSend={true}
            ...
            textInputProps={{
              editable: !messageProcessPending,
            }}
            renderBubble={props => {
              ...
              >
                <View style={{marginRight: 12, marginBottom: 8}}>
                  <Ionicons
                    ...
                    size={26}
                    color={
                      props.text?.trim().length && !messageProcessPending
                        ? PRIMARY_COLOR
                        : '#9ca3af'
                    }
                  />
