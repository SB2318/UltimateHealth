...
export function postMethodCallwithToken(url: string, params: BaseModel, authToken: string): Promise<BaseModel> {
...
export function getMethodCallwithToken(url: string, authToken: string): Promise<BaseModel> {
