...
### Set ANDROID_HOME in your system path
...
* Enter the path to the Android SDK directory as the variable value. (Default Value: ~ C:\Users\User_Name\AppData\Local\Android\Sdk ~ )
